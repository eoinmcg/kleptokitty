...
export default class Player extends Sprite {
  ...
  update() {
    ...
    if (!moving && (!this.dir.x || !this.dir.y)) {
      if (keyWasPressed('ArrowRight') || d == 'right') this.dir = vec2(1, 0);
      else if (keyWasPressed('ArrowLeft') || d == 'left') this.dir = vec2(-1, 0);
      else if (keyWasPressed('ArrowUp') || d == 'up') this.dir = vec2(0, 1);
      else if (keyWasPressed('ArrowDown') || d == 'down') this.dir = vec2(0, -1);
    }
