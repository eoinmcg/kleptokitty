 ...
 *  @type {Color}
 *  @memberof UISystemPlugin */
let uiDefaultButtonColor = ORANGE;

/** Default hover color for UI elements
 *  @type {Color}
 *  @memberof UISystemPlugin */
let uiDefaultHoverColor  = YELLOW;
...
class UIObject
{
     ...
     */
    constructor(pos=vec2(), size=vec2(), color = uiDefaultColor, lineColor = uiDefaultLineColor)
    {
...
class UIText extends UIObject
{
     ...
     *  @param {string}  [align]
     *  @param {string}  [font=uiDefaultFont]
     *  @param {string}  [color=uiDefaultTextColor]
     *  @param {string}  [hover]
     */
    constructor(pos, size, text='', align='center', font=uiDefaultFont, color=uiDefaultTextColor, hover)
    {
        super(pos, size);
        ...
        this.hoverColor = hover || uiDefaultHoverColor;
        this.canHover = hover;
    ...
    render()
    {
        const color = this.mouseIsOver && this.canHover ? this.hoverColor : this.textColor;
        drawUIText(this.text, this.pos, this.size, color, this.lineWidth, this.lineColor, this.align, this.font);
    }
}
...
class UIButton extends UIObject
{
    ...
    render()
    {
        // let lineColor = this.mouseIsHeld ? this.hoverColor : this.lineColor;
